...
export default class Admin extends Component {
  ...
  handleModalAddVisible = (flag) => {
    this.props.form.resetFields(['add_username', 'add_password', 'add_role', 'add_email']);
  ...
  handleModalAddSubmit = (e) => {
    ...
    this.props.form.validateFields(['add_username', 'add_password', 'add_role', 'add_email'], (err, values) => {
      if (err) return;
      this.props.dispatch({
        type: 'admin/add',
        payload: {
  ...
  handleModalUpdateVisible = (flag) => {
    this.props.form.resetFields(['update_role', 'update_email']);
  ...
  handleModalUpdateSubmit = (e) => {
    ...
    this.props.form.validateFields(['update_role', 'update_email'], (err, values) => {
      if (err) return;
      this.props.dispatch({
        type: 'admin/update',
        payload: {
  ...
  render(){
    ...
    const { form, admin, role } = this.props;
